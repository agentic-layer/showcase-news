...
# Showcase Components
k8s_resource('news-workforce', labels=['workforce'], resource_deps=['agent-runtime'], pod_readiness='ignore')
k8s_resource('news-agent', labels=['workforce'], resource_deps=['news-fetcher', 'summarizer-agent'], port_forwards='8001:8000')
k8s_resource('summarizer-agent', labels=['workforce'], resource_deps=['news-fetcher'], port_forwards='8002:8000')
k8s_resource('news-fetcher', labels=['workforce'], resource_deps=['agent-runtime'], port_forwards='8003:8000')
