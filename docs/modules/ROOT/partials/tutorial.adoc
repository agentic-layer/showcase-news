...
See the xref:agent-gateway-operator:operator:how-to-guide.adoc[agent-gateway-operator] installation instructions.

===== Install an Agent Gateway instance

Configure an `AgentGateway` instance: xref:agent-gateway-operator:gateway:how-to-guide.adoc[see example].
