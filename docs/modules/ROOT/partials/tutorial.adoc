...
Configure an `AgentGateway` instance: xref:agent-runtime-operator:agent-gateways:how-to-guide.adoc[see example].
...
Configure an `AiGateway` instance: xref:agent-runtime-operator:ai-gateways:how-to-guide.adoc[see example].
